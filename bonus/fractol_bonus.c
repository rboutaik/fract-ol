...
/*   Updated: 2024/02/04 00:19:14 by rboutaik         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_errors(void)
{
	...
	ft_putstr_fd("\x1b[35m\t./fractol tricorn\n\x1b[0m", 1);
	ft_putstr_fd("\n\x1b[34mUsage :\n\x1b[0m", 1);
	ft_putstr_fd("\x1b[36m\tZoom in, Zoom out : -> mouse\n\x1b[0m", 1);
	ft_putstr_fd("\x1b[36m\tMoving forward : -> arrows\n\x1b[0m", 1);
	ft_putstr_fd("\x1b[36m\tColors shifting : -> space\n\x1b[0m", 1);
	ft_putstr_fd("\x1b[36m\tIterations shifting : -> plus/minus\n\x1b[0m", 1);
